...
# Обчислення необхідної кількості ітерацій на основі epsilon
def calculate_required_iterations(a, b, epsilon):
    ...
    while fib[-1] < (b - a) / epsilon:
        ...
        n += 1
    return fib, n - 2  # n-2, бо останній елемент уже перевищив (b-a)/epsilon

# Метод Фібоначчі з похибкою
def fibonacci_minimize(f, x1, x2, epsilon=0.01):
    ...
    for i in range(1, iter):
        ...
        if rho[i] == 0.5:
            rho[i] -= 1e-6  # захист від рівності
...
if __name__ == "__main__":
    ...
    fibonacci_minimize(f, x1=-1.5, x2=-1, epsilon=0.01)
